...
public class UserActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (useDarkTheme) {
            setTheme(R.style.AppTheme_Dark); //changes theme
        }
        ...
        ownerNumber = intent.getStringExtra("ownerNumber"); //gets data sent by detailactivity
        ...
        if (useSafeSearch) { //searches for photos with safe_search=1
            String url = "https://api.flickr.com/services/rest/?method=flickr.people.getPhotos&api_key=3b39db216c7028189a1319b050b79fed&format=json&nojsoncallback=?&extras=description,owner_name,url_m,url_l,url_o,date_taken&safe_search=1&per_page=5&user_id=" + ownerNumber;
            ...
            String url = "https://api.flickr.com/services/rest/?method=flickr.people.getPhotos&api_key=3b39db216c7028189a1319b050b79fed&format=json&nojsoncallback=?&extras=description,owner_name,url_m,url_l,url_o,date_taken&per_page=5&user_id=" + ownerNumber;
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, responseListener, errorListener);
        ...
        getSupportActionBar().setTitle(ownerName + "'s Photos"); //toolbar tile
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            ActivityOptions options = ActivityOptions
                    .makeSceneTransitionAnimation(UserActivity.this);
            ...
            Intent intent = new Intent(UserActivity.this, FavActivity.class);
            ActivityOptions options = ActivityOptions
                    .makeSceneTransitionAnimation(UserActivity.this);
            startActivity(intent, options.toBundle());
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
                ...
                for (int i = 0; i < photoList.length(); i++) {
                    ...
                    NetworkMgr.getInstance(UserActivity.this).imageList.add(newImage);
                }
