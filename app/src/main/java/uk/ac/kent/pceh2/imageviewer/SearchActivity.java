...
/**
 * Created by Phoebe on 01/12/2017.
 */
...
public class SearchActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        isNetworkConnectionAvailable(); //check internet connection
        ...
        searchText.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            @Override
            public boolean onEditorAction(TextView textView, int actionId, KeyEvent event) { //if message entered
                if ((event != null && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER)) || (actionId == EditorInfo.IME_ACTION_DONE)) {
                    onSubmitMessage(textView);
                }
                return false;
            }
        });
        ...
        TextView searchInfoText = (TextView) findViewById(R.id.searchInfoText);

        Animation out = new AlphaAnimation(1.0f, 0.0f); //animates text to fade out
        out.setDuration(5000);

        searchInfoText.startAnimation(out);
    }
    ...
    public void onSubmitMessage(View view) {
        refresh();

        hideSoftKeyboard();

        recyclerView = (RecyclerView) findViewById(R.id.photoListView); //shows the recycler view wth photos
        ...
        public void onResponse(JSONObject response) {
            ...
            try {
                ...
                for (int i = 0; i < photoList.length(); i++) {
                    ...
                    adapter.imageList.add(newImage);
                }
    ...
    void refresh() {
        ...
        //gets message entered in TextEdit
        ...
        if (useSafeSearch) { //search with safe_search=1
            String url = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=3b39db216c7028189a1319b050b79fed&format=json&nojsoncallback=1&extras=description,owner_name,url_m,url_l,url_o,date_taken&safe_search=1&per_page=50&text=" + message;
            ...
            String url = "https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=3b39db216c7028189a1319b050b79fed&format=json&nojsoncallback=1&extras=description,owner_name,url_m,url_l,url_o,date_taken&per_page=50&text=" + message;
            JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, responseListener, errorListener);
